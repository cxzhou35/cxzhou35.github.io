...
import VisionProIcon from '../components/icons/visionpro'
  ...
  <Layout>
    <Container>
      ...
      <Box display={{ md: 'flex' }} mt={2}>
        <Box flexGrow={1}>
          ...
          <Box display="flex" alignItems="center" gap={2}>
            <Text fontFamily="LXGW WenKai TC" fontSize={24}>
              周晨旭
            </Text>
            <NamePopover
      ...
      <Section delay={0.1}>
        ...
        <Paragraph>
          I am a first-year Ph.D. student in Computer Science at Zhejiang
          University, advised by{' '}
          <Link
            as={NextLink}
            href="https://www.xzhou.me/"
            passHref
            scroll={false}
            target="_blank"
          >
          ...
          . My research interests lie in the fields of 3D/4D reconstruction and
          generative models. My long-term goal is to{' '}
          <b>
            create immersive, interactive environments that seamlessly integrate
            digital and physical worlds
          </b>
          —experiences akin to the virtual realms envisioned in film{' '}
          <Link
          ...
          >
            <Box as="span" display="inline-flex" alignItems="center">
              Ready Player One <VisionProIcon />
            </Box>
          </Link>
          .
        </Paragraph>
        ...
        <Paragraph>
          Previously, I obtained my bachelor degree from College of Optical
          Science and Engineering and Chu Kochen Honors College (ACEE) at{' '}
          <Link
            as={NextLink}
          ...
          in 2024. During the summer of 2023, I was privileged to work closely
          with Taichi Graphics (now{' '}
          <Link
            as={NextLink}
        ...
        <List>
          ...
          <ListItem>
            <ListIcon
              ...
              color={useColorModeValue('linkLight', 'linkDark')}
            />
            Enthusiast of Vim/Neovim, I love its design philosophy and
            efficiency.
          </ListItem>
          <ListItem>
            <ListIcon
            ...
            />
            My personal{' '}
            <Link href="https://note.zicx.top/" scroll={false} target="_blank">
              notebook
            </Link>
