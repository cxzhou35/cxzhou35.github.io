...
cp ~/dotfiles/vim/vimscript/plug.vim  ~/.vim/autoload/
cp ~/dotfiles/vim/vimscript/.vimrc ~
...
# 配置
git clone https://github.com/cxzhou35/Awesome-dotfiles.git ~/dotfiles # 前面操作中 clone 过的不需要再 clone
...
git clone https://github.com/cxzhou35/Awesome-dotfiles.git ~/dotfiles  # 前面操作中clone过的不需要再clone
...
{{< admonition info >}}
想要了解更多**其他系统**的配置内容，可以到这个 [Github Wiki](https://github.com/cxzhou35/Awesome-dotfiles/wiki) 查看哦🫰🏼
{{< /admonition >}}
